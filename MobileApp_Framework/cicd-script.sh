...
######################################################################
zephyrBaseUrl="https://test.atlassian.net/"
...
# Task info
taskName="Android Automation"
taskDescription="Test Android Automation Task"
...
assigneeUser="6*****"
mandatoryFields='{"reporter":{"label":"Naveen C","name":"Naveen C","id":"6*****"}}'

# Name of the test result file
resultPath="@//Users/naveenc/PycharmProjects/Employ_D_MobileApp/output/junitxml_report.xml"
